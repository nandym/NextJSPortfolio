...
const Main = ({ children }) => {
  return (
    <Box as="main" pb={3} bgGradient='linear(to-br, #7d4e57,rgb(20, 40, 71), #7d4e57 )'  >
      ...
      <Box h={12}></Box>
      <Container pt={17} rounded={30} mb={20} maxW="container.xl" bgGradient='linear(173deg,rgba(120,120,120,0.5),rgba(0, 0, 0, 0.21) 20% )' border={"0"} borderColor={"rgba(0, 0, 0, 0.11)"} boxShadow={"dark-lg"} >
        {children}
        <Contacts />
      </Container>
